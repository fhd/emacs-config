...

;;;### (autoloads nil "po-compat" "po-compat.el" (0 0 0 0))
;;; Generated autoloads from po-compat.el
 (autoload 'po-find-file-coding-system "po-compat")

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "po-compat" '("po-")))
...
all reachable through 'M-x customize', in group 'Emacs.Editing.I18n.Po'." t nil)
 (add-to-list 'auto-mode-alist '("\\.po[tx]?\\'\\|\\.po\\." . po-mode))
 (modify-coding-system-alist 'file "\\.po[tx]?\\'\\|\\.po\\." 'po-find-file-coding-system)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "po-mode" '("N_" "po-")))

;;;***

;;;### (autoloads nil nil ("po-mode-pkg.el" "start-po.el") (0 0 0
;;;;;;  0))
