...
(defvar adict-dictionary-list
  ...
  (mapcar 'adict-guess-dictionary-name
          '(nil
            ...
            ("hu" "magyar" "hungarian")
            ("ro" "românâ" "româneœô ÿte" "romanian")
            ("pt" "português" "portuguese")))
...
(defvar adict-hash
  ...
  (let ((hash (make-hash-table :test 'equal)))
    ...
    (adict-add-word hash 2 "eins" "zwei" "drei" "vier" "fünf" "sechs" "sieben"
       ...
       "zusammen" "zwar" "zwecks" "zwischen" "bezüglich" "dafür" "für"
       "gegenüber" "gemäß" "schließlich" "über" "während" "würde" "zunächst"
       "zusätzlich")
    (adict-add-word hash 3 "aller" "allez" "allons" "alors" "au" "aux" "avoir"
       ...
       "faisons" "fait" "faites" "il" "ils" "je" "là" "mais" "ne" "oui" "où"
       "parce" "pas" "plaît" "pour" "pourquoi" "quand" "qui" "revoir" "une"
       "des" "vais" "vas" "voient" "voir" "vois" "voit" "vont" "vous" "voyez"
       "voyons" "à" "ça" "être")
    (adict-add-word hash 4 "además" "ahora" "al" "algo" "algunos" "antes"
       "aquí" "así" "aunque" "año" "años" "bueno" "cada" "casa" "casi" "caso"
       "como" "con" "contra" "cosas" "creo" "cuando" "cómo" "decimos" "decir"
       "decis" "del" "desde" "después" "dicen" "dices" "digo" "dijo" "donde"
       "dos" "día" "días" "ejemplo" "ella" "ellos" "entonces" "entre"
       "era" "eres" "esa" "ese" "eso" "esta" "estaba" "estado" "estas"
       "esto" "estos" "está" "están" "forma" "fue" "general" "gente" "gobierno"
       "gran" "había" "hace" "hacemos" "hacen" "hacer" "haces" "hacia"
       "hacéis" "hago" "han" "hasta" "hay" "hecho" "hombre" "hoy" "las" "lo"
       "los" "luego" "mayor" "mejor" "menos" "mientras" "mismo"
       "momento" "mucho" "mujer" "mundo" "muy" "más" "mí" "nada" "ni" "no" "nos"
       "nosotros" "otra" "otras" "otro" "otros" "parece"
       "parte" "país" "pero" "personas" "poco" "poder" "política" "porque"
       "primera" "puede" "pueden" "qué" "sea" "según" "ser" "si"
       "siempre" "sino" "sois" "somos" "son" "soy" "su" "sus" "sí"
       "sólo" "tal" "también" "tan" "tanto" "tenemos" "tener" "tengo"
       "tenéis" "tenía" "tiempo" "tiene" "tienen" "tienes" "time" "toda" "todas"
       "todo" "todos" "trabajo" "tres" "una" "uno" "unos" "usted" "vamos" "ve"
       "veces" "veis" "ven" "veo" "ver" "ves" "vida" "y" "ya" "yo" "él")
    (adict-add-word hash 5 "och" "att" "en" "som" "det" "är" "av" "på"
       "ett" "två" "tre" "fyra" "fem" "sex" "sju" "åtta" "nio" "tio"
       "du" "jag" "inte" "nej" "vad" "defvar" "hej" "har" "kan"
       "om" "för" "till" "barn" "eller" "finns" "många" "när"
       "från" "ska" "klotter" "tycker" "sig" "vara" "vill" "konst" "så" "få"
       "mycket" "andra" "måste" "göra" "skulle" "deras" "sverige" "här" "sina"
       "bara" "också" "kommer" "hur" "alla" "gör" "sedan" "någon"
       "efter")
    (adict-add-word hash 6
       ;; slovenian (based on http://bos.zrc-sazu.si/a_top2000_si.html)
       "ali" "ampak" "bi" "bil" "biti" "bo" "bodo" "bolj" "bom" "brez" "œô ­as"
       "œô ­e" "celo" "œô ­eprav" "œô ­ez" "dan" "danes" "deset" "do" "dobro" "dolgo"
       "dovolj" "drugaœô ­e" "drugi" "dva"
       ...
       "konec" "kot" "lahko" "lep" "let" "malo" "manj" "moœô ­no"
       "mogoœô ­e" "mu" "nad" "naj" "najveœô ­" "nam" "namreœô ­" "naprej"
       "nas" "naœô¡¡" "nazaj" "nekaj" "niœô ­" "nihœô ­e" "nikoli" "niso"
       "niti" "nov" "oœô ­itno" "od" "okoli" "oziroma" "pa" "paœô ­" "pet"
       "po" "poœô ­asi" "pod" "pol" "poleg" "potem" "pozdrav" "prav" "pred"
       "predvsem" "prej" "pri" "primer" "prosim" "proti" "prvi" "ravno"
       "res" "saj" "sam" "œô¡¡e" "sedaj" "œô¡¡ele" "sem" "seveda" "sicer"
       "skoraj" "skupaj" "smo" "so" "spet" "sploh" "sta" "ste" "œô¡¡tevilo"
       "œô¡¡tiri" "sto" "stran" "svoj" "ta" "tako" "takoj" "takrat" "tam"
       "tega" "teh" "tem" "teœô¡¾ko" "tisoœô ­" "tisto"
       "tokrat" "toliko" "torej" "treba" "tudi" "tukaj" "veœô ­" "vedno"
       "veliko" "velja" "vendar" "vsaj" "vsak" "vse" "vsi" "za" "zadnji"
       "zakaj" "zakon" "zaradi" "zato" "zdaj" "œô¡¾e" "zelo" "zgolj")
    (adict-add-word hash 7 "az" "èn" "ö" "ti" "ök" "csak" "hogy"
       "nem" "igen" "és" "így" "úgy" "s" "jól" "van" "nincs" "nekem" "neki"
       "amely" "ki" "fel" "ezek" "azok" "ezen" "azon" "közé"
       "meg" "még" "azaz" "aki" "volt" "egyéb" "vagy" "ennek" "annak" "talán")
    (adict-add-word hash 8 "nu" "ea" "noi" "voi" "ei"
       "sœô £" "în" "peste" "œô ÿi" "la" "unless" "despre" "din" "cele" "dintre"
       "avem" "vœô £" "oricare" "se" "acest" "fi" "pe" "care" "mai" "dacœô £" "cum"
       "te" "numai" "sunt""fost" "când" "aœô¡£i" "am" "pentru" "acum" "acesta"
       "ca" "sub" "ani")
    (adict-add-word hash 9
      ;; from http://home.unilang.org/main/wiki2/index.php/Portuguese_wordlist
      "e" "são" "em" "têm" "mas" "querido" "querida" "caro" "cara" "para"
      "obter" "pegar" "oi" "aquilo" "coisa" "meu" "não" "pôr"
      "meter" "colocar" "acerca" "algum" "alguns" "alguma" "algumas" "lá" "além"
      "nós" "eles" "ela" "elas" "teu" "enquanto" "com" "contigo" "você" "vosso"
      "sim" "olá" "tchau" "adeus" "bem-vindo" "obrigado" "obrigada" "já"
      "também" "sempre" "bonito" "certamente" "claramente" "cedo"
      "longe" "tarde" "provavelmente" "alto" "talvez" "muito" "perto"
      "agora" "apenas" "possivelmente" "raramente" "ainda" "acolá" "hoje"
      "amanhã" "improvável" "bem" "errado" "ontem")
